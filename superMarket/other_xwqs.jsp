...
<div class="logo_swzl"><a href="../index.jsp"><img src="img/LOGO_XWQS.jpg" /></a></div>
...
%>
	<div class="block">
    	<p class="title"><strong>寻物主题:</strong>&nbsp;<%= rs.getString("title_table") %></p>
        <p class="names"><strong>发布者&nbsp;:</strong>&nbsp;<%= rs.getString("name_table") %></p>
        <span class="texts"><strong>寻物内容:</strong>&nbsp;<%= rs.getString("information") %></span>
    </div>
<%
	}
%>
