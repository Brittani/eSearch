...
<div class="pageBody">
	<div class="body_img"><img src="img/products/login.jpg" /></div>
    <div class="body_block">
    	<form method="post"
        name="form1"
        action="jspTool/loginTool.jsp" 
        onsubmit="return checkEmpty()">
        
    	<div class="body_title"><img src="img/products/titleLogin.jpg" /></div>
        <div class="body_item">
        ...
        <div class="body_item">
        	<div class="item_str"><span>输入密码：</span></div>
            <div><input name="PW" type="password" /></div>
            <div class="item_tip"><p>*请输入密码仅限6~12位。</p></div>
        </div>
        <div class="item_sureBtn"><input class="input_btnLogin" type="submit" value="" /></div>
        </form>
    </div>
