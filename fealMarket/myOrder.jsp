...
<div class="body_porducts">
    ...
    <div class="information_imgs">
    	<div class="bar">
            ...
            <div class="bar_item"><p>商品代号</p></div>
            <div class="bar_item"><p>交易日期</p></div>
            <div class="bar_item"><p>商品提供者</p></div>
        </div>
	 ...
	 String sql = "select * from orderTable where buyer='"+ owner+"'";
	...
	sql = "select * from ordertable where buyer = '"+owner+"'" + " limit "+n+","+pageSize;
	...
	while(rs.next()){
		%>
            ...
            <div class="bar_item"><span><%= rs.getString("PID") %></span></div>
           	 ...
           	 <div class="bar_item"><span><%= rs.getString("productID") %></span></div>
           	 <div class="bar_item"><span><%= rs.getString("thisDate") %></span></div>
             <div class="bar_item"><span><%= rs.getString("owner") %></span></div>
        	</div>            
        <%
		}
	...
	if(currentPage!=1){
		%>
        	<p><a href="myOrder.jsp?currentPage=<%= currentPage-1 %>" >上一页</a></p>
        <%
	}
	if(currentPage*pageSize<totalNum){
		%>
        	<span><a href="myOrder.jsp?currentPage=<%= currentPage+1 %>" >下一页</a></span>
        <%
	}
